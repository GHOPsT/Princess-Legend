...
export const PrincessSprite = ({ direction }: { direction: string }) => (
  <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g transform={direction === 'left' ? 'scale(-1, 1) translate(-24, 0)' : ''}>
      {/* Shadow */}
      <ellipse cx="12" cy="21" rx="6" ry="2" fill="black" opacity="0.3" />
      
      {/* Dress Bottom (Dark Pink) */}
      <path d="M6 16 L4 21 H20 L18 16 Z" fill="#b91c7a" />
      <path d="M6 16 H18 L16 12 H8 Z" fill="#e83e8c" />
      
      {/* Dress Detail */}
      <rect x="11" y="14" width="2" height="8" fill="#ff9ec8" />
      
      {/* Torso/Arms */}
      <rect x="9" y="9" width="6" height="4" fill="#e83e8c" />
      ...
      {/* Hair (Brown) */}
      <path d="M8 4 H16 V6 H17 V10 H15 V6 H9 V6 H7 V10 H8 V4" fill="#5C4033" />
      <rect x="6" y="5" width="2" height="6" fill="#5C4033" />
      <rect x="16" y="5" width="2" height="6" fill="#5C4033" />
...
// Village Map
const villageTiles = createEmptyGrid(15, 11, 'grass'); // Slightly taller
// Lake
...
// Path
for(let i=0; i<15; i++) villageTiles[8][i] = 'floor'; // Main road

// Decorative Walls/Bushes (Using wall type but logic will handle look)
